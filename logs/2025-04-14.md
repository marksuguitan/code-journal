...
- Speech-To-Text - this endpoint will allow me to collect information from things like podcasts or youtube videos and convert them to text for an LLM model to analyze and eventually synthesize something like a newsfeed that I can listen to in the morning.
